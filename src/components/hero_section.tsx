  ...
  return (
    <section className="min-h-[80vh] flex items-center justify-center text-center pt-20 px-5 relative overflow-hidden">
      <div className="relative isolate px-6 pt-14 lg:px-8">
        <div aria-hidden="true" className="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-90">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-36 lg:py-48">
          ...
          <div className="text-center">
            <h1 className="text-5xl font-semibold tracking-tight text-balance text-white sm:text-7xl animate-fadeInUp" style={{ animationDelay: '0.4s' }}>Biarkan Picly bantu kamu bersinar</h1>
            <p className="mt-8 text-lg font-medium text-pretty text-gray-400 sm:text-xl/8 animate-fadeInUp" style={{ animationDelay: '0.6s' }}>Desain yang tepat bisa bikin brand kamu lebih menonjol. Yuk tingkatkan tampilan bisnismu dengan sentuhan kreatif dari Picly</p>
